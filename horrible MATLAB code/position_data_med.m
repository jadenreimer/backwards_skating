...
ccut_amplitude = (34 - 16) / 2; % additional stance width at peak of ccut in inches
...
%% left time
t1 = linspace(6.43, 6.43+(7.1-6.43)/2, q_period);
t2 = linspace(6.43+(7.1-6.43)/2, 7.1, q_period);
%         t1 = linspace(6.43, 6.73,q_period);
%         t2 = linspace(6.73, 6.9, q_period);

%         t3 = linspace(6.9, 6.9+(8-6.9)/2, q_period);
%         t4 = linspace(6.9+(8-6.9)/2, 8, q_period);
t3 = linspace(7.1, 7.6, q_period);
t4 = linspace(7.6, 7.9, q_period);

%         t5 = linspace(8, 8.3, q_period);
%         t6 = linspace(8.3, 8.57, q_period);
t5 = linspace(7.9, 7.9+ (8.7-7.9)/2, q_period);
t6 = linspace(7.9+ (8.7-7.9)/2, 8.7, q_period);

%         t7 = linspace(8.57, 8.57+(9.43-8.57)/2, q_period);
%         t8 = linspace(8.57+(9.43-8.57)/2, 9.43, q_period);
t7 = linspace( 8.7, 9.03, q_period);
t8 = linspace(9.03, 9.3, q_period);

%         t9 = linspace(9.43, 9.77, q_period);
%         t10 = linspace(9.77, 10.1, q_period);
t9 = linspace(9.3, 9.3+(10.3-9.3)/2, q_period);
t10 = linspace(9.3+(10.3-9.3)/2, 10.3, q_period);

t11 = linspace(10.3, 10.4, q_period);
%         t11 = linspace(10.1, 10.4, q_period);
%         t12 = linspace(10.4, 9.23, q_period);
...
t5 = linspace(8, 8.3, q_period);
t6 = linspace(8.3, 8.57, q_period);
%         t5 = linspace(7.9, 8.3, q_period);
%         t6 = linspace(8.3, 8.57, q_period);

t7 = linspace(8.57, 8.57+(9.43-8.57)/2, q_period);
t8 = linspace(8.57+(9.43-8.57)/2, 9.43, q_period);
%         t7 = linspace( 8.57, 9.03, q_period);
%         t8 = linspace(9.03, 9.3, q_period);

t9 = linspace(9.43, 9.77, q_period);
t10 = linspace(9.77, 10.1, q_period);
%         t9 = linspace(9.3, 9.77, q_period);
%         t10 = linspace(9.77, 10.1, q_period);
